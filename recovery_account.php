            ...
            <div class="d-flex flex-column justify-content-center align-items-center" style="padding-top: 150px;">
                <div class="col-lg-6">
                    <div class="card mb-5" style="background: hsl(204 100% 5%); border-radius: 15px;">
                        <div class="card-body">
                            <h1 class="text-custom text-uppercase fw-bold">Recovery Account</h1>
                            <hr>
                            <div class="register-account">
                                <div id="result"></div>
                                <div class="alert alert-info" style="background-color: rgba(0,0,0,0.3);">
                                    Just type Username and your a new password, after that we will give you an link of verification of resetting your passowrd in your email.
                                </div>
                                <label for="username">
        ...
        <script>
            $(document).ready(function() {
                $(".onSubmit").click(function() {
                    ...
                    $.ajax({
                        url: './backend/recovery_account.php',
                        data: {
                            username: username,
                            password: password,
