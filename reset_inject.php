                ...
                <div class="card mb-5" style="background: hsl(204 100% 5%); border-radius: 15px;">
                    <div class="card-body">
                        <div class="text-uppercase fw-bold px-5">
                            <h1 class="text-custom">Reset Password Failed</h1>
                            <p class="text-custom">Your account cannot be resetting.
                            </p>
                            <hr>
                            <p class="text-custom fw-bold fs-1 text-center">SQL Injection Detected.</p>
                            <div class="d-flex justify-content-center">
                                <img src="./img/alarm.png" class="mb-3">
                            </div>
                            <p class="fw-bold text-custom text-center">Your account cannot be resetting due to custom token using Symbol.<br>Check your email again and click the Link of Verification.</p>
                        </div>
                    </div>
                    <!-- </div> -->
                </div>
