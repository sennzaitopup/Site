                ...
                <div class="card mb-5" style="background: hsl(204 100% 5%); border-radius: 15px;">
                    <div class="card-body">
                        <div class="text-uppercase fw-bold px-5">
                            ...
                            <p class="fw-bold text-custom text-center">Your account cannot be verified due to custom token using Symbol.<br>Check your email again and click the Link of Verification.</p>
                        </div>
                    </div>
                    <!-- </div> -->
                </div>
