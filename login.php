            ...
            <div class="d-flex flex-column justify-content-center align-items-center" style="padding-top: 150px;">
                <div class="col-lg-6">
                    <div class="card mb-5" style="background: hsl(204 100% 5%); border-radius: 15px;">
                        <div class="card-body">
                            <h1 class="text-custom text-uppercase fw-bold">Login</h1>
                            <hr>
                            <div class="register-account">
                                ...
                                <hr>
                                <p class="text-custom text-center">Forget your password? <a href="./recovery_account.php">Recovery Account</a></p>
                            </div>
                        </div>
                    </div>
                    <!-- </div> -->
