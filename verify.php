                ...
                <div class="card mb-5" style="background: hsl(204 100% 5%); border-radius: 15px;">
                    <div class="card-body">
                        <div class="text-uppercase fw-bold px-5">
                            <h1 class="text-custom">Blocked Page</h1>
                            <hr>
                            <p class="text-custom fw-bold fs-1 text-center">Your account is need verification.</p>
                            <div class="d-flex justify-content-center">
                                <img src="./img/alarm.png" class="mb-3">
                            </div>
                            <p class="fw-bold text-custom text-center">You cannot access this page because you haven't verify your account. <br>Please verify your account with login to LostSaga Forever.</p>
                        </div>
                    </div>
                    <!-- </div> -->
                </div>
