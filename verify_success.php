                ...
                <div class="card mb-5" style="background: hsl(204 100% 5%); border-radius: 15px;">
                    <div class="card-body">
                        <div class="text-uppercase fw-bold px-5">
                            <h1 class="text-custom">Verification Success</h1>
                            <p class="text-custom">Your account has been verified.
                            </p>
                            <hr>
                            <p class="text-custom fw-bold fs-1 text-center">Thanks for verifying your account.</p>
                            <div class="d-flex justify-content-center">
                                <img src="./img/checked.png" class="mb-3">
                            </div>
                            <p class="fw-bold text-custom text-center">Verify account success. <br>Now you can access the member page in this website.<br>But, dont give your data account to anyone!</p>
                        </div>
                    </div>
                    <!-- </div> -->
                </div>
