                ...
                <div class="card mb-5" style="background: hsl(204 100% 5%); border-radius: 15px;">
                    <div class="card-body">
                        <div class="text-uppercase fw-bold px-5">
                            ...
                            <hr>
                            <p class="text-custom fw-bold fs-1 text-center">Server Error.</p>
                            <div class="d-flex justify-content-center">
                                <img src="./img/404.png" class="mb-3">
                            </div>
                            <p class="fw-bold text-custom text-center">The server have been error and cannot continue your request. Please try again later.</p>
                        </div>
                    </div>
                    <!-- </div> -->
                </div>
