            ...
            <div class="card mb-5" style="background: hsl(204 100% 5%); border-radius: 15px;">
                <div class="card-body">
                    <div class="text-uppercase fw-bold px-5">
                        <h1 class="text-custom">Top 10 Rank</h1>
                        <p class="text-custom">Here you can see the top 10 of Rank.
                        </p>
                        <div class="table-responsive">
                            <table class="table table-striped table-hover table-dark border-dark border border-primary">
                                ...
                                <tbody>
                                    ...
                                    $query = odbc_exec($Connection, "SELECT TOP 10 * FROM userGameDB INNER JOIN userMemberDB ON userGameDB.accountIDX = userMemberDB.accountIDX Order by userEXP DESC");
                                    ...
                                    ?>
                                        ...
                                        <tr class="text-white">
                                            <td><?= $row->nickName; ?></td>
                                            <td><?= number_format($row->userEXP, 0, ' ', '.'); ?></td>
                                        </tr>
                                    <?php
                                    }
                                    ?>
